  ...
  return (
    <>
      ...
      <article className="legal-page container">
        ...
        <section><h2>2. Information collected by this website</h2><p>This website does not intentionally use analytics, advertising cookies, tracking pixels, or an online contact form.</p></section>
        ...
        <section><h2>7. Contact</h2><p>For privacy questions, email <a href={`mailto:${company.generalEmail}`}>{company.generalEmail}</a>.</p></section>
      </article>
    </>
  );
}
